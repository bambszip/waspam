...
def Tokped():
	...
	print
	number = raw_input(''+C+'MASUKKAN NOMOR TARGET'+W+' ('+H+' Ex :'+C+' 0812xxxx '+W+') : ')
	jumlah = input(''+C+'JUMLAH SPAM'+W+' ('+H+' Ex :'+C+' 9999999 '+W+') : ')
	print
	MesinTik_2(''+C+'-------------- '+W+'Starting'+C+' --------------')
	print
	for x in range(jumlah):
		try:
			...
			if 'Anda sudah melakukan 9999999 kali pengiriman kode' in sending.text:
				print
...
def Spam():
	...
	sleep(1.5)
	os.system('xdg-open https://m.youtube.com/channel/UCq6mBsDqmKsaA1XQjpkXLmA')
	os.system('clear')
	sleep(1.3)
	Banner()
	print
